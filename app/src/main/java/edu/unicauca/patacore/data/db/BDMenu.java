...
public class BDMenu {
    ...
    public static final String CREAR_TABLA_PEDIDO ="CREATE TABLE IF NOY EXISTS " + TABLA_PEDIDO +
            " ("+CAMPO_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "+CAMPO_NOM_PROD+" TEXT, "+CAMPO_NOM_PROD+" TEXT, "+CAMPO_NOM_PROD+" TEXT, "
